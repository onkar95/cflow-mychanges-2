      ...
      <div className='service-user-content'>
        ...
        { window.screen.width>=870 && 
          ...
          >
            ...
            >
              <Tab label='Construction Materials' {...a11yProps(0)} />
              <Tab label='Agents' {...a11yProps(1)} />
              <Tab label='Commercial Vehicles' {...a11yProps(2)} />
              <Tab label='Construction Chemicals' {...a11yProps(3)} />
            </Tabs>
            </AppBar> 
        }

        {
          ...
          style={{backgroundColor:theme?"white":"", color:theme?"black":"white", width:"90%", marginLeft:"5%"}}
      >
          <Select
          ...
          <TabPanel
            ...
            style={{
              backgroundColor: theme ? '#ffffff' : '#121111',
              color: theme ? 'black' : '',
              padding: window.screen.width<1400?'0rem':'5rem',
            }}
          >    
            {currentSection === 0 && (
